...
export default function () {
  describe('route', () => {
    ...
    it('/1041/route?timezone=Asia/Tokyo&detils=true', async () =>
      req(app)
    ...
    it('/1041/route?timezone=Asia/Tokyo&detils=true&first_arrival_time=18:55:00', async () =>
      req(app)
        .get(
    ...
    it('/1041/route?timezone=Asia/Tokyo&detils=true&first_departure_time=18:55:00', async () =>
      req(app)
        .get(
    ...
    it('/1041/route?timezone=Asia/Tokyo&detils=true&first_arrival_time=18:55:00&first_departure_time=18:55:00', async () =>
      req(app)
        .get(
